...
function CallLang($clg) {
    ...
    $urlLang = "https://chill-music.github.io/SpotX/scripts/installer-lang/$clg.ps1"
...
if ($langCode -eq 'ru') { 
    $ru = $true
    $urlru = "https://chill-music.github.io/SpotX/patches/Augmented%20translation/ru.json"
...
$url = "https://chill-music.github.io/SpotX/patches/patches.json"
$retries = 0

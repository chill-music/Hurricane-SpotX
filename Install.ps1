...
function CallLang($clg) {
    ...
    $urlLang = "https://raw.githubusercontent.com/chill-music/Hurricane-SpotX/main/scripts/installer-lang/$clg.ps1"
...
Write-Host ($lang).InstallComplete`n -ForegroundColor Green + ($lang).InstallComplete2`n -ForegroundColor Red

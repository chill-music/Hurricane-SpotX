...
╚════════════════════════════════════════╝"
    ...
    NoRestore       = "SpotX قبلاً نصب شده است، اما فایل‌هایی برای بازیابی xpui.js.bak و xpui.css.bak یافت نشد. `nلطفاً کلاینت Spotify را حذف نصب کنید و Install.bat را دوباره اجرا کنید"

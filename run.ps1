...
function CallLang($clg) {
    ...
    $urlLang = "https://chill-music.github.io/Hurricane-SpotX/scripts/installer-lang/$clg.ps1"
...
if ($langCode -eq 'ru') { 
    $ru = $true
    $urlru = "https://raw.githubusercontent.com/chill-music/Hurricane-SpotX/patches/Augmented%20translation/ru.json"
...
$url = "https://raw.githubusercontent.com/chill-music/Hurricane-SpotX/patches/patches.json"
$retries = 0
